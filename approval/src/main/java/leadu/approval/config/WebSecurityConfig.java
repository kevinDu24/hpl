...
import leadu.approval.security.RestAuthenticationEntryPoint;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().antMatchers(
                ...
                "/system/verifyCode" ,"/attachment/**","/approval/**","approval_details.html", "approval_result.html","approval_home.html",
                "/files/**","/order/**"
                );
